...
export default class EditScreenOne extends React.Component {
  ...
  esconderTeclado (texto) {
    Alert("HOLA");
    return texto
  }
  esconderTeclado2 = (texto) => {
     Alert("HOLA");
    return texto
  };
  showAlert = () => {
  ...
  <Right />
   ...
   <View style={{bottom:20}}>
     ...
     <View >
        ...
        style={{borderRadius:45,marginTop:40,fontWeight: '500' ,color: 'grey',height: 50,
      ...
      paddingTop: 0,paddingBottom: -50,letterSpacing:15}}
        ...
        />
           ...
           backgroundColor={this.state.buttonColor}
            full
            square
            style={{ borderRadius:45,marginTop: 20,width:220,height:80,left: 40, }}

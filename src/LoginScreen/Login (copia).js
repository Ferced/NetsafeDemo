...
import PickerExample from './../ProfileScreen/PickerExample.js'
...
<Header style={{backgroundColor:'#14929E'}}>
        ...
        />
          ...
          <Body>
    <Image source={require('./../ProfileScreen/logos-04.png')} style={{height: 80,width: 100,left:60}}/>
              </Body>
          <Right />
        </Header>
...
<View style={{backgroundColor:'#A8A9AB',height:2.5,width:340,left:9,marginTop:50}}></View>
        <Content padder >
           <Button
            ...
            square
            blue
            style={{ marginTop: 20,borderRadius:20,width:220,height:80,backgroundColor: '#14929E',left: 60,Right:0 }}
